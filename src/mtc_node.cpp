...
//   object1.primitives[0].dimensions = { 0.4, 0.02 };

//   geometry_msgs::msg::Pose pose1;
//   pose1.position.x = 0.5;
//   pose1.position.y = -0.25;
//   pose1.position.z = 0.21;
...
#pragma GCC diagnostic pop
  ...
  //         std::make_unique<mtc::stages::ModifyPlanningScene>("allow collision (robot,object)");
  //     stage_allow_base_collision->allowCollisions("object","panda_link0",
  //                           // task.getRobotModel()
